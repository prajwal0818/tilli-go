...
/** Inferred type from Zod — matches CreateTaskDTO */
export type CreateTaskSchemaOutput = z.infer<typeof createTaskSchema>;

/** Inferred type from Zod — matches UpdateTaskDTO */
export type UpdateTaskSchemaOutput = z.infer<typeof updateTaskSchema>;
