...
import type { Project, ProjectContextType, CreateProjectInput } from './types';
...
function App() {
  ...
  const refreshProjects = useCallback(async (newProjectData?: CreateProjectInput): Promise<Project | void> => {
    if (newProjectData) {
